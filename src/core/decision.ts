...
/** Terminal: hard-block the command with `<prefix> denied: <reason>` on
 *  stderr + exit 2. Warning/note annotations are DROPPED when a deny fires;
 *  `error` annotations always survive.
 *  @stable @since 1.0.0 */
