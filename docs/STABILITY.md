...
- **Header marker:** INTERNAL is applied at the file level when an entire module is plumbing. Per-export `@stable` tags inside an otherwise-internal file override the file-level marker; the export's tier wins.
